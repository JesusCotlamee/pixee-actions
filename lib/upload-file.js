...
function uploadPayload(inputs, logger) {
        ...
        try {
            axios_1.default.put((0, util_1.buildApiUrl)(inputs), form, {
                ...
                if (error instanceof util_1.UserError) {
                    ...
                    throw new util_1.UserError(error.message);
                }
            ...
            throw new util_1.UserError(`Response status: ${error}`);
        }
    }).catch(error => {
